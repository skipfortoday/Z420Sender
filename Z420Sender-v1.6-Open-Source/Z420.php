...
if ($checkingjson->valid == 'true') {
	if ($expiredjson->expired == 'true') {
		if ($accessjson->access == 'true') {
			...
			try {
				...
				echo "\033[3".$rand."m================================= Z420 Sender 2K18 ".$version." ================================\n";
			} catch (Exception $e) {
			...
			echo "\033[3".$rand."m============================== PLEASE COMEBACK TOMORROW ===============================\n";
			echo "\033[3".$rand."m=================================== Z420 Sender 2K18 ".$version." ==================================\n";
		}
	}else{
	...
	echo "\n";
	echo "\n";
	echo "\033[3".$rand."m=========================== Your apikey not valid in server ============================\n";
	echo "\033[3".$rand."m=============================== Have problem? Contact me ===============================\n";
	echo "\033[3".$rand."m=================================== Z420 Sender 2K18 ".$version." ===================================\n";
}
